...
from apps.review_workbench.pages.cloud_spike import source_fragment
...
<style>{asset_text('cloud_analysis.css')}</style>
...
<script>{asset_text('cloud_analysis.js')}</script></body></html>"""
