...
<style>{asset_text('cloud_spike.css')}</style><style>{asset_text('cloud_spike_runs.css')}</style><body><header><b>Uteki / Data</b>{status}<a href='/result'>{bi('Business view','业务视图')}</a><button id='language'>EN / 中文</button></header>
...
<script>{asset_text('cloud_spike.js')}</script></body></html>"""
