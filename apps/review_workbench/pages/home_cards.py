...
def render_home(universe, rows, now=None):
    from apps.review_workbench.pages.attention_dashboard import attention_model, report_url
    ...
    body += '<style>'+asset_text('home_cards.css')+'</style><script>'+asset_text('home_cards.js')+'</script>'
