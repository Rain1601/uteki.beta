...
CSS='''
*{box-sizing:border-box}body{margin:0;font:15px/1.7 "Avenir Next","PingFang SC",sans-serif;color:#202b3b;background:#fff}a{color:#275dad;text-decoration:none}a:hover{text-decoration:underline}button,input{font:inherit}button{background:white;border:1px solid #e1e7ef;padding:6px 12px;border-radius:5px;cursor:pointer}[lang=en]{display:none}html[data-language=en] [lang=en]{display:inline}html[data-language=en] [lang=zh]{display:none}[hidden]{display:none!important}.workspace-main{max-width:1250px;margin:auto;padding:24px 36px 80px}.workspace-language{display:flex;justify-content:flex-end;padding:8px 36px}.breadcrumbs{display:flex;gap:10px;flex-wrap:wrap;font-size:13px;color:#596779}.workspace-heading{margin:30px 0}.workspace-heading h1{font-size:32px;margin:0 0 8px}.workspace-heading p,.muted{color:#596779}.home-layout{display:grid;grid-template-columns:minmax(0,1fr) 280px;gap:60px}.continue-report{padding:22px 28px;background:#f5f7fa;border-left:4px solid #275dad}.continue-report h3{font-size:23px;line-height:1.45;margin:10px 0}.primary-link{display:inline-block;padding:9px 17px;background:#275dad;color:#fff;border-radius:5px;margin-top:8px}.home-context{padding-top:0}.home-context h2{margin:0 0 18px}.company-shortcut{display:flex;justify-content:space-between;border-bottom:1px solid #e1e7ef;padding:12px 0}.research-path{padding-left:20px;font-size:14px}.research-path li{padding:9px 0}.home-context>h2:not(:first-child){margin-top:36px}.section-heading{display:flex;align-items:center;justify-content:space-between;margin-top:34px}.report-list-row{display:flex;justify-content:space-between;gap:24px;border-bottom:1px solid #e1e7ef;padding:20px 0}.report-title{font-size:17px;font-weight:600}.report-list-row p{margin:5px 0;color:#596779}.report-list-row small{font-size:12px;color:#596779;display:block}.report-list-state{flex:0 0 115px;text-align:right}.report-status{font-size:13px;color:#596779}.company-tabs{display:flex;gap:28px;border-bottom:1px solid #e1e7ef;margin:22px 0;overflow:auto}.company-tabs a{padding:12px 0;white-space:nowrap}.company-tabs a[aria-current]{border-bottom:2px solid #275dad;font-weight:600}.company-sections{display:grid;grid-template-columns:repeat(3,1fr);gap:35px;margin:32px 0}.company-section{color:#202b3b;border-bottom:2px solid #e1e7ef;padding-bottom:20px}.company-section h2{font-size:20px}.company-section p{color:#596779;font-size:14px}.workspace-table,.scroll{overflow:auto}.workspace-table table,.scroll table{border-collapse:collapse;width:100%;font-size:13px}.workspace-table th,.workspace-table td,.scroll td,.scroll th{text-align:left;padding:12px;border-bottom:1px solid #e1e7ef;vertical-align:top}.workspace-table th,.scroll th{background:#f5f7fa}.directory-search{display:flex;gap:16px;align-items:center}.directory-search input{padding:8px 12px;border:1px solid #e1e7ef;border-radius:5px;min-width:260px}.coverage-note{border-left:3px solid #275dad;background:#f5f7fa;padding:15px 20px}.controls{display:flex;gap:12px;margin:20px 0}.controls input,.controls select{padding:8px;border:1px solid #e1e7ef;border-radius:4px}.workspace-main h2{margin-top:28px}.workspace-main small{display:block}.workspace-empty{padding:25px 0;color:#596779}a:focus-visible,button:focus-visible,input:focus-visible,select:focus-visible{outline:3px solid #275dad;outline-offset:3px}@media(max-width:800px){.home-layout{grid-template-columns:1fr;gap:30px}.home-context{border-top:1px solid #e1e7ef;padding-top:25px}.workspace-main{padding:20px}.company-sections{grid-template-columns:1fr;gap:12px}.company-tabs{gap:20px}.controls{flex-wrap:wrap}.directory-search{display:block}.directory-search input{display:block;width:100%;min-width:0}.report-list-row{gap:12px}.report-list-state{flex-basis:84px}}@media(prefers-reduced-motion:reduce){*{scroll-behavior:auto!important}}
'''

CSS += """
.company-research-layout{display:grid;grid-template-columns:minmax(0,1fr) 270px;gap:48px}.company-report-main>.section-heading{margin-top:0}.company-report-main>.section-heading h2{margin-top:0}.featured-report{padding:20px 25px;background:#f5f7fa;border-left:3px solid #275dad;margin:12px 0 32px}.featured-report h3{font-size:23px;line-height:1.5;margin:8px 0 14px;font-weight:600}.featured-report>p{font-size:14px;max-width:60ch}.research-support{border-left:1px solid #e1e7ef;padding-left:28px}.research-support h2{margin-top:0}.support-link{display:block;margin:24px 0 6px}.support-link strong,.support-link span{display:block}.support-link span,.research-support>.muted,.index-guidance p{font-size:13px;color:#596779;margin-top:5px}.index-guidance{margin-top:26px;font-size:13px}.index-guidance summary{cursor:pointer;color:#596779}@media(max-width:850px){.company-research-layout{grid-template-columns:1fr;gap:30px}.research-support{border-left:0;border-top:1px solid #e1e7ef;padding:24px 0 0}.featured-report{padding:18px}.featured-report h3{font-size:20px}}
"""
