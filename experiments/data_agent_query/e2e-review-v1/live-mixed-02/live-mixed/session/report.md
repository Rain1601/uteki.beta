...
| 任务 | 信息要求 | 取证方式 |
| --- | --- | --- |
| read-business-chapter | 完整读取 Alphabet FY2025 10-K 的 Business 章节（Item 1）原文，并返回该章节的完整阅读覆盖与未读范围。 | read\_node |
| query-cloud-metrics | 查询 Google Cloud 2025 年收入、营业利润和营业利润率，返回计算依据与原文引用。 | query |
...
| 要求 | 已返回 / 要求总量 | 未读 | 下次起点 |
| --- | --- | --- | --- |
| read-business-item-1 | 79 / 79 | 0 | 无 |
...
| 轮 | 动作 | 反馈 | 正文累计覆盖 |
| --- | --- | --- | --- |
| 1 | query | recorded | 0/79 |
| 2 | read\_source | recorded | 10/79 |
| 3 | read\_source | recorded | 22/79 |
| 4 | read\_source | recorded | 32/79 |
| 5 | read\_source | recorded | 45/79 |
| 6 | read\_source | recorded | 61/79 |
| 7 | read\_source | recorded | 71/79 |
| 8 | read\_source | recorded | 79/79 |
| 9 | finish | finish\_accepted | 79/79 |
