...
VERSION = "transcript-records-v0.1"
...
TOPIC_BOUNDARY = re.compile(r"^(?:In terms of expenses|Turning to|Moving to|Next,|Now,)", re.I)
...
def extract_transcript_records(source_dir, index_dir, *, expanded_guidance=False):
    ...
    for block in reader.blocks:
        ...
        guidance = {"record_type": "Guidance", "source_block_id": block["block_id"],
                    "source_snapshot_id": manifest["source_snapshot_id"], "entity_id": "alphabet",
                    ...
                    "context_policy": "same_turn_next_3_until_topic_boundary" if expanded_guidance else "existing_reader_one_block",
