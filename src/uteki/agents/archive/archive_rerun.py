...
from uteki.agents.reading.material_library import load_catalog, pin_materials
from uteki.agents.archive.research_archive import ArchiveError
from uteki.agents.archive.research_archive_context import build_context
...
async def run_archive_revision(root, store, output, *, source_id, document_ids,
    ...
    """
    from uteki.agents.analysis.analysis_comparison import run_mode
    from uteki.agents.runtime.call_costs import pricing_snapshot
    rows=store.list()
